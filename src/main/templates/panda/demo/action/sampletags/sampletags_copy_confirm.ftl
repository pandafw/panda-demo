...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.form cssClass="n-cform" id="sampletags" method="post" theme="nxhtml">
			...
			/>
			<@n.submit icon="icon-copy-execute" action="sampletags_copy_execute" group="start"><@n.text name="button-copy-execute"/></@n.submit>
			<@n.submit icon="icon-back" action="sampletags_copy_input" group="end"><@n.text name="button-back"/></@n.submit>
		</@n.form>
	</div>
</div>
