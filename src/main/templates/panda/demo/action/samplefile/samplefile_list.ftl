...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.listview id="samplefile_list" action="samplefile_list" 
		...
		>
			<@s.param name="tools">
				<#if action.hasPermission("samplefile_bdelete")>
					<@n.submit icon="icon-bdelete" action="samplefile_bdelete" onclick="return samplefile_list_bdelete();" theme="simple"><@n.text name="button-bdelete"/></@n.submit>
				</#if>
				<#if action.hasPermission("samplefile_list_print")>
					<@n.submit icon="icon-print" onclick="return samplefile_list_print();" theme="simple"><@n.text name="button-print"/></@n.submit>
				</#if>
				<#if action.hasPermission("samplefile_list_csv")>
					<@n.submit icon="icon-csv" onclick="return samplefile_list_csv();" theme="simple"><@n.text name="button-csv"/></@n.submit>
				</#if>
				<#if action.hasPermission("samplefile_list_print")>
					<@n.submit icon="icon-pdf-list_print" onclick="return samplefile_list_pdf_list_print();" theme="simple"><@n.text name="button-pdf-list_print"/></@n.submit>
				</#if>
			</@s.param>
		</@n.listview>
		...
		<script type="text/javascript"><!--
			function samplefile_list_bdelete() {
				return nlv_submitCheckedKeys('samplefile_list', '<@n.url action="samplefile_bdelete"/>');
			}
			function samplefile_list_print() {
				window.open("<@n.url action='samplefile_list_print' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function samplefile_list_csv() {
				window.open("<@n.url action='samplefile_list_csv' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function samplefile_list_pdf_list_print() {
				window.open("<@n.url action='pdf' namespace='/' escapeAmp='false'/>?url=" + encodeURIComponent("<@n.url action='samplefile_list_print' forceAddSchemeHostAndPort='true' escapeAmp='false'/>" + location.search));
				return false;
			}
		--></script>
	</div>
