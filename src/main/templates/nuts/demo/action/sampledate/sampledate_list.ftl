...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.listview id="sampledate_list" action="sampledate_list" 
		...
		>
			<@s.param name="tools">
				<#if action.hasPermission("sampledate_bdelete")>
					<@n.submit icon="icon-bdelete" action="sampledate_bdelete" onclick="return sampledate_list_bdelete();" theme="simple"><@n.text name="button-bdelete"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampledate_list_print")>
					<@n.submit icon="icon-print" onclick="return sampledate_list_print();" theme="simple"><@n.text name="button-print"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampledate_list_csv")>
					<@n.submit icon="icon-csv" onclick="return sampledate_list_csv();" theme="simple"><@n.text name="button-csv"/></@n.submit>
				</#if>
				<#if action.hasPermission("/json/sampledate_list")>
					<@n.submit icon="icon-json" onclick="return sampledate_list_json();" theme="simple"><@n.text name="button-json"/></@n.submit>
				</#if>
				<#if action.hasPermission("/xml/sampledate_list")>
					<@n.submit icon="icon-xml" onclick="return sampledate_list_xml();" theme="simple"><@n.text name="button-xml"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampledate_list_print")>
					<@n.submit icon="icon-pdf-list_print" onclick="return sampledate_list_pdf_list_print();" theme="simple"><@n.text name="button-pdf-list_print"/></@n.submit>
				</#if>
			</@s.param>
		</@n.listview>
		...
		<script type="text/javascript"><!--
			function sampledate_list_bdelete() {
				return nlv_submitCheckedKeys('sampledate_list', '<@n.url action="sampledate_bdelete"/>');
			}
			function sampledate_list_print() {
				window.open("<@n.url action='sampledate_list_print' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampledate_list_csv() {
				window.open("<@n.url action='sampledate_list_csv' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampledate_list_json() {
				window.open("<@n.url action='sampledate_list' namespace='/json' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampledate_list_xml() {
				window.open("<@n.url action='sampledate_list' namespace='/xml' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampledate_list_pdf_list_print() {
				window.open("<@n.url action='pdf' namespace='/' escapeAmp='false'/>?url=" + encodeURIComponent("<@n.url action='sampledate_list_print' forceAddSchemeHostAndPort='true' escapeAmp='false'/>" + location.search));
				return false;
			}
		--></script>
	</div>
