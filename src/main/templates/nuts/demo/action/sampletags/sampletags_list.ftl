...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.listview id="sampletags_list" action="sampletags_list" 
		...
		>
			<@s.param name="tools">
				<#if action.hasPermission("sampletags_bdelete")>
					<@n.submit icon="icon-bdelete" action="sampletags_bdelete" onclick="return sampletags_list_bdelete();" theme="simple"><@n.text name="button-bdelete"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampletags_list_print")>
					<@n.submit icon="icon-print" onclick="return sampletags_list_print();" theme="simple"><@n.text name="button-print"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampletags_list_csv")>
					<@n.submit icon="icon-csv" onclick="return sampletags_list_csv();" theme="simple"><@n.text name="button-csv"/></@n.submit>
				</#if>
				<#if action.hasPermission("/json/sampletags_list")>
					<@n.submit icon="icon-json" onclick="return sampletags_list_json();" theme="simple"><@n.text name="button-json"/></@n.submit>
				</#if>
				<#if action.hasPermission("/xml/sampletags_list")>
					<@n.submit icon="icon-xml" onclick="return sampletags_list_xml();" theme="simple"><@n.text name="button-xml"/></@n.submit>
				</#if>
				<#if action.hasPermission("sampletags_list_print")>
					<@n.submit icon="icon-pdf-list_print" onclick="return sampletags_list_pdf_list_print();" theme="simple"><@n.text name="button-pdf-list_print"/></@n.submit>
				</#if>
			</@s.param>
		</@n.listview>
		...
		<script type="text/javascript"><!--
			function sampletags_list_bdelete() {
				return nlv_submitCheckedKeys('sampletags_list', '<@n.url action="sampletags_bdelete"/>');
			}
			function sampletags_list_print() {
				window.open("<@n.url action='sampletags_list_print' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampletags_list_csv() {
				window.open("<@n.url action='sampletags_list_csv' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampletags_list_json() {
				window.open("<@n.url action='sampletags_list' namespace='/json' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampletags_list_xml() {
				window.open("<@n.url action='sampletags_list' namespace='/xml' includeParams='all' escapeAmp='false'/>");
				return false;
			}
			function sampletags_list_pdf_list_print() {
				window.open("<@n.url action='pdf' namespace='/' escapeAmp='false'/>?url=" + encodeURIComponent("<@n.url action='sampletags_list_print' forceAddSchemeHostAndPort='true' escapeAmp='false'/>" + location.search));
				return false;
			}
		--></script>
	</div>
