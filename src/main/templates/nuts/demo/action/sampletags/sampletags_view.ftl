...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.form cssClass="n-vform" id="sampletags" method="post" theme="nxhtml">
			<@n.viewfield
				name="d.id"
			...
			<@n.viewfield
				name="d.boolField"
				format="check"
				label="%{getText('view-boolField', '')}"
			/>
			
			<@n.viewfield
				name="d.intField"
				label="%{getText('view-intField', '')}"
			/>
			
			<@n.viewfield
				name="d.decField"
				label="%{getText('view-decField', '')}"
			/>
			
			<@n.viewfield
				name="d.radioField"
				list="consts.radioMap"
				label="%{getText('view-radioField', '')}"
			/>
			
			<@n.viewfield
				name="d.selectField"
				list="consts.selectMap"
				label="%{getText('view-selectField', '')}"
			/>
			
			<@n.viewfield
				name="d.checkField"
				list="consts.checkMap"
				label="%{getText('view-checkField', '')}"
			/>
			
			<@n.viewfield
				name="d.datetimeField"
				format="datetime"
				label="%{getText('view-datetimeField', '')}"
			/>
			
			<@n.viewfield
				name="d.dateField"
				format="date"
				label="%{getText('view-dateField', '')}"
			/>
			
			<@n.viewfield
				name="d.timeField"
				format="time"
				label="%{getText('view-timeField', '')}"
			/>
			
			<@n.viewfield
				name="d.htmlField"
				label="%{getText('view-htmlField', '')}"
			/>
			
			<@n.viewfield
				name="d.bbcodeField"
				label="%{getText('view-bbcodeField', '')}"
			/>
			<#assign _buttons_ = [] />
