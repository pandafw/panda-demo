...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.form cssClass="n-cform" id="samplefile" method="post" theme="nxhtml">
			...
			<@n.submit icon="icon-copy-execute" action="samplefile_copy_execute" group="start"><@n.text name="button-copy-execute"/></@n.submit>
			<@n.submit icon="icon-back" action="samplefile_copy_input" group="end"><@n.text name="button-back"/></@n.submit>
		</@n.form>
	</div>
</div>
