...
<div class="n-sect">
	...
	<div class="n-sect-body">
		...
		<@n.form cssClass="n-cform" id="sampleunique" method="post" theme="nxhtml">
			...
			/>
			<@n.submit icon="icon-insert-execute" action="sampleunique_insert_execute" group="start"><@n.text name="button-insert-execute"/></@n.submit>
			<@n.submit icon="icon-back" action="sampleunique_insert_input" group="end"><@n.text name="button-back"/></@n.submit>
		</@n.form>
	</div>
</div>
