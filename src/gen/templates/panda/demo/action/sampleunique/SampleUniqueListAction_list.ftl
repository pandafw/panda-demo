...
<div class="p-section">
	...
	>
		<@p.param name="tools">
			...
			<#if action.hasPermission("~/list_print")>
				<@p.submit icon="icon-pdf" onclick="return sampleunique_list_pdf();" theme="simple"><@p.text name="button-pdf"/></@p.submit>
			</#if>
		</@p.param>
	</@p.listview>
	...
	<script type="text/javascript"><!--
		function sampleunique_list_bdelete() {
			return nlv_submitCheckedKeys('sampleunique_list', '<@p.url action="~/bdelete"/>');
		}
