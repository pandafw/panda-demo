...
<div class="p-section">
	...
	<@p.set var="lvtools">
		...
		<#if action.hasPermission("~/list_print")>
			<@p.b icon="icon-print" onclick="return sampleunique_list_print();" label="#(button-print)"/>
		</#if>
		<#if action.hasPermission("~/list_csv")>
			<@p.b icon="icon-csv" onclick="return sampleunique_list_csv();" label="#(button-csv)"/>
		</#if>
		<#if action.hasPermission("~/list_json")>
			<@p.b icon="icon-json" onclick="return sampleunique_list_json();" label="#(button-json)"/>
		</#if>
		<#if action.hasPermission("~/list_xml")>
			<@p.b icon="icon-xml" onclick="return sampleunique_list_xml();" label="#(button-xml)"/>
		</#if>
		<#if action.hasPermission("/pdf")>
			<@p.b icon="icon-pdf" onclick="return sampleunique_list_pdf();" label="#(button-pdf)"/>
		</#if>
	</@p.set>
	...
	<script type="text/javascript"><!--
		...
		function sampleunique_list_pdf() {
