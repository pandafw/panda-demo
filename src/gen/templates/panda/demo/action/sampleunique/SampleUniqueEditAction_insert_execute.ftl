...
<div class="p-section">
	<div class="p-header">
		<ol class="breadcrumb">
			...
			<li class="active"><@p.text name="step-insert-success"/></li>
		</ol>
	</div>
...
</li></#if><#if r??><li><@p.a icon="icon-pdf" target="_blank" action="/pdf"><@p.param name="url"><@p.url action='sampleunique_pdf' forceAddSchemeHostAndPort='true' escapeAmp='false'><@p.param name="id" value="%{r.id}"/></@p.url></@p.param><@p.text name='button-pdf'/></@p.a>
