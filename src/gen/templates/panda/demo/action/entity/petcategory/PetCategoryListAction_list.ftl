...
<#if a.canAccess("./import")><li><@p.a action="./import" icon="icon-import" label="#(btn-import)"/>
	...
	<@p.set var="lvtools">
		<#if a.canAccess("./bdelete")>
			<@p.b onclick="return petcategory_list_bdelete();" icon="icon-bdelete" label="#(btn-bdelete)"/>
		</#if>
		<#if a.canAccess("./benable")>
			<@p.b onclick="return petcategory_list_benable();" icon="icon-benable" label="#(btn-benable)"/>
		</#if>
		<#if a.canAccess("./bdisable")>
			<@p.b onclick="return petcategory_list_bdisable();" icon="icon-bdisable" label="#(btn-bdisable)"/>
		</#if>
	</@p.set>

	<@p.queryer id="petcategory_list_qr" action="./list"
		columns=_columns_
	/>

	<@p.listview id="petcategory_list" action="./list"
	...
	<script type="text/javascript"><!--
		function petcategory_list_bdelete() {
			return plv_submitCheckedKeys('petcategory_list', '<@p.url action="./bdelete"/>', null, "");
		}
		function petcategory_list_benable() {
			return plv_submitCheckedKeys('petcategory_list', '<@p.url action="./benable"/>', null, "");
		}
		function petcategory_list_bdisable() {
			return plv_submitCheckedKeys('petcategory_list', '<@p.url action="./bdisable"/>', null, "");
		}
	--></script>
</div>
