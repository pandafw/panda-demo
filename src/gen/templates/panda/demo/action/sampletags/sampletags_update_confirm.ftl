...
<div class="p-section">
	...
	<@p.form cssClass="p-cform" id="sampletags" initfocus="true" method="post" theme="bs3h">
		...
		<@p.div cssClass="p-buttons">
			<@p.submit icon="icon-update-execute" action="sampletags_update_execute"><@p.text name="button-update-execute"/></@p.submit>
			<@p.submit icon="icon-back" action="sampletags_update_input"><@p.text name="button-back"/></@p.submit>
		</@p.div>
	</@p.form>
</div>
