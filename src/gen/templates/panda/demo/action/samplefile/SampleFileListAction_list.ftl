...
</li></#if><#if a.canAccess("~/list_csv")><li><@p.a icon="icon-csv" target="_blank" action="~/list_csv" label="#(button-csv)"/>
</li></#if><#if a.canAccess("~/list_json")><li><@p.a icon="icon-json" target="_blank" action="~/list_json" label="#(button-json)"/>
</li></#if><#if a.canAccess("~/list_xml")><li><@p.a icon="icon-xml" target="_blank" action="~/list_xml" label="#(button-xml)"/>
</li></#if><#if r?has_content><li><@p.a icon="icon-pdf" label="#(button-pdf)" target="_blank" action="/pdf"><@p.param name="url"><@p.url action="~/list_pdf" forceAddSchemeHostAndPort="true" escapeAmp="false" includeParams="all"/></@p.param></@p.a>
...
<#if a.displayField("utime")>
	...
	<@p.set var="lvtools">
		<#if a.canAccess("~/bdelete")>
			<@p.b icon="icon-bdelete" onclick="return samplefile_list_bdelete();" label="#(button-bdelete)"/>
		</#if>
		<#if a.canAccess("~/benalbe")>
			<@p.b icon="icon-benable" onclick="return samplefile_list_benable();" label="#(button-benable)"/>
		</#if>
		<#if a.canAccess("~/bdisable")>
			<@p.b icon="icon-bdisable" onclick="return samplefile_list_bdisable();" label="#(button-bdisable)"/>
		</#if>
	</@p.set>
	...
	<script type="text/javascript"><!--
		function samplefile_list_bdelete() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/bdelete"/>', null, "");
		}
		function samplefile_list_benable() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/benalbe"/>', null, "");
		}
		function samplefile_list_bdisable() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/bdisable"/>', null, "");
		}
	--></script>
</div>
