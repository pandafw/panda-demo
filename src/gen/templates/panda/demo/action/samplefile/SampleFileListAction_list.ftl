...
<div class="p-section">
	...
	<@p.set var="lvtools">
		...
		<#if action.hasPermission("~/list_print")>
			<@p.b icon="icon-print" onclick="return samplefile_list_print();" label="#(button-print)"/>
		</#if>
		<#if action.hasPermission("~/list_csv")>
			<@p.b icon="icon-csv" onclick="return samplefile_list_csv();" label="#(button-csv)"/>
		</#if>
		<#if action.hasPermission("~/list_json")>
			<@p.b icon="icon-json" onclick="return samplefile_list_json();" label="#(button-json)"/>
		</#if>
		<#if action.hasPermission("~/list_xml")>
			<@p.b icon="icon-xml" onclick="return samplefile_list_xml();" label="#(button-xml)"/>
		</#if>
		<#if action.hasPermission("/pdf")>
			<@p.b icon="icon-pdf" onclick="return samplefile_list_pdf();" label="#(button-pdf)"/>
		</#if>
	</@p.set>
	...
	<script type="text/javascript"><!--
		function samplefile_list_bdelete() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/bdelete"/>');
		}
		function samplefile_list_benable() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/benalbe"/>');
		}
		function samplefile_list_bdisable() {
			return plv_submitCheckedKeys('samplefile_list', '<@p.url action="~/bdisable"/>');
		}
