...
public abstract class UserEditAction extends WebEditAction<User> {
	...
	public UserEditAction() {
		setType(User.class);
		addDisplayFields(User.ID, User.NAME, User.EMAIL, User.PASSWORD, User.ROLE, User.STATUS, User.CREATED_AT, User.CREATED_BY, User.CREATED_BY_USER, User.UPDATED_AT, User.UPDATED_BY, User.UPDATED_BY_USER);
	}
